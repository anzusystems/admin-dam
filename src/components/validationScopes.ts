import type { DistributionUpdateDto } from '@/types/coreDam/Distribution.ts'
...
export const DistributionUpdateDtoValidationScopeSymbol = Symbol.for('anzu:distribution-update-dto-validation-scope')
