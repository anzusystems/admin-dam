...
<template>
  <VLayout>
    ...
    <VAppBar density="compact" :order="-1" elevation="0" class="system-border-b">
      <div class="d-flex w-100 justify-space-between align-center overflow-x-auto pb-2 pt-1 py-sm-2 pr-1">
        ...
        <div class="d-flex align-center">
          ...
          <AAdminSwitcher :config-url="envConfig.adminSwitcherConfigUrl" class="mr-1" />
          <CurrentUserDropdown />
        </div>
      </div>
    </VAppBar>
    ...
    <VDialog v-if="customDialog" :model-value="true" fullscreen class="overlay--sidebar">
      <VCard>
