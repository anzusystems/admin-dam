...
import type { DamCurrentUserDto, DamUserUpdateDto, FilterBag, Pagination } from '@anzusystems/common-admin'
...
export const updateUser = (id: number, data: DamUserUpdateDto) =>
  apiUpdateOne<DamUserUpdateDto, User>(damClient, data, END_POINT + '/:id', { id }, SYSTEM_CORE_DAM, ENTITY)
