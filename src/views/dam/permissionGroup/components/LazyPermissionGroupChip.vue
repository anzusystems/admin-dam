...
import { useLazyPermissionGroup } from '@/views/dam/permissionGroup/composables/lazyPermissionGroup'
...
const onClick = () => {
  router.push({ name: ROUTE.DAM.PERMISSION_GROUP.DETAIL, params: { id: props.id } })
}
</script>
