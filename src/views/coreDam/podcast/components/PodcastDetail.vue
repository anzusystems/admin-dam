...
<template>
  <VRow>
    <VCol cols="8">
      ...
      <ARow :title="t('coreDam.podcast.model.attributes.extUrl')" :value="podcast.attributes.extUrl" />
    ...
    <VCol cols="4">
      ...
      <ARow v-if="imageSrc" :title="t('coreDam.podcast.model.imagePreview')">
        <AssetImage :src="imageSrc" use-component />
      </ARow>
      <ARow v-if="altImgSrc" :title="t('coreDam.podcast.model.altImage')">
        <AssetImage :src="altImgSrc" use-component />
      </ARow>
