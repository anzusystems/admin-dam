...
import { useLazyPodcast } from '@/views/coreDam/podcast/composables/lazyPodcast'
...
const { has, get, loadedAll } = useLazyPodcast()
...
const onClick = () => {
  router.push({ name: ROUTE.DAM.PODCAST.DETAIL, params: { id: props.id } })
}
</script>
