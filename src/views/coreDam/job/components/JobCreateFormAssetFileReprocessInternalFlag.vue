...
import { ref } from 'vue'
import type { JobAssetFileReprocessInternalFlag } from '@/types/coreDam/Job'
...
const { createAssetFileReprocessInternalFlag } = useJobFactory()
const job = ref<JobAssetFileReprocessInternalFlag>(createAssetFileReprocessInternalFlag())
...
const { createJob } = useJobApi<JobAssetFileReprocessInternalFlag>(damClient, SYSTEM_CORE_DAM)
