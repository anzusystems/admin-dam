...
<template>
  <VCardText>
    <ARow>
      <AFormTextField v-model="job.podcastId" :label="t('coreDam.job.model.podcastId')" data-cy="podcastId" required />
    </ARow>
    <ARow>
      <VSwitch v-model="job.fullSync" :label="t('coreDam.job.model.fullSync')" data-cy="fullSync" />
    </ARow>
  </VCardText>
  <VCardActions>
    <VSpacer />
