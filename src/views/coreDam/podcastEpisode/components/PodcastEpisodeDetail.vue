...
<template>
  <VRow>
    <VCol cols="8">
      ...
      />
      <ARow :title="t('coreDam.podcastEpisode.model.attributes.rssUrl')" :value="podcastEpisode.attributes.rssUrl" />
      <ARow :title="t('coreDam.podcastEpisode.model.attributes.extUrl')" :value="podcastEpisode.attributes.extUrl" />
