...
<template>
  <VBtn icon size="small" variant="text" data-cy="button-download" @click.stop="onClick">
    ...
    <VCard v-if="dialog" data-cy="delete-panel">
      ...
      <VCardText>
        ...
        <div v-else-if="link" class="w-100 text-center mt-4">
          <VBtn color="primary" prepend-icon="mdi-download" :href="link" data-cy="button-download-file">
      ...
      <VCardActions>
        <VSpacer />
        <VBtn variant="text" data-cy="button-cancel" @click.stop="onCancel">
