...
<template>
  <div v-if="previewLink">
    <div class="d-flex align-center">
      <VChip color="success" label size="small" class="mr-2">
      ...
      <VBtn variant="text" size="small" :href="previewLink" target="_blank" class="text-left mr-2">
        {{ t('coreDam.asset.assetFilePublicLink.actions.openOnNewTab') }} <VIcon size="small" icon="mdi-open-in-new" />
      </VBtn>
      <VBtn size="small" variant="text" @click.stop="makePrivate">
  ...
  <div v-else>
    <div class="d-flex align-center">
      <VChip color="primary" label size="small" class="mr-2">
        {{ t('coreDam.asset.assetFilePublicLink.status.private') }}
      </VChip>
      <VBtn size="small" variant="text" @click.stop="makePublic">
