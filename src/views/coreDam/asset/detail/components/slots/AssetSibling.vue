...
<template>
  <div v-if="assetDetailStore.asset" class="pa-4 pb-8 text-body-medium">
    <VRow>
      <VCol>
      ...
      <VCol cols="3" class="text-right">
        ...
        >
          <template #activator="{ props: assetSelectProps }">
            <VBtn variant="text" class="my-2 mr-2" size="small" v-bind="assetSelectProps" :loading="siblingLoader">
  ...
  <div v-else class="pa-4 text-body-small">
