...
export const ACL = {
  ...
  DAM_ASSET_LIST_VIEW_CREATE: 'dam_assetListView_create',
  DAM_ASSET_LIST_VIEW_UPDATE: 'dam_assetListView_update',
  DAM_ASSET_LIST_VIEW_READ: 'dam_assetListView_read',
  DAM_ASSET_LIST_VIEW_DELETE: 'dam_assetListView_delete',
  DAM_ASSET_LIST_VIEW_LIST: 'dam_assetListView_list',
  ...
  DAM_ASSET_LIST_VIEW_UI: 'dam_assetListView_ui',
