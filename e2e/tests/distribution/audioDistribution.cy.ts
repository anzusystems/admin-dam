...
describe(`Test distribution Audio function, Env: ${CY.cfg}`, { tags: ['@distributionAudio', '@distribution'] }, () => {
  ...
  it('Distribute audio', () => {
    ...
    cy.get(':nth-child(2) > .text-body-2 > :nth-child(2) > .v-col > .v-chip > .v-chip__content').should(
      'include.text',
      'Distribuovaný'
    ) // JW distribution
