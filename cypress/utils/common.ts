...
export const USER_LICENCE = ['CMS licence', 'Anzulák: Blog plný radosti']
export const EXTERNAL_SYS = ['cms', 'blog', 'tools']
export const EXTERNAL_PROVIDER = 'Unsplash'
export const DISTRIBUTION_SERVICE = ['Youtube CMS', 'Youtube Fičí', 'JwVideo']
...
export const TEST_USER_ID = '10001040'
