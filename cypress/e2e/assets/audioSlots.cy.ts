...
describe(`Test audio slots function, Env: ${CY.cfg}`,
  ...
  it('Public-Private', ()=>{
    ...
    cy.get('.sidebar-info .mdi-dots-vertical').click()
    cy.waitSec(1)
    cy.get('.v-list-item-title').contains('Nastaviť ako verejné').click()
    ...
    cy.get('.sidebar-info .mdi-dots-vertical').click()
    cy.waitSec(1)
    cy.get('.v-list-item-title').contains('Nastaviť ako súkromné').click()
  ...
  it('Change Slots with each other', ()=>{
    ...
    cy.get('.sidebar-info .mdi-dots-vertical').eq(1).click()
    cy.waitSec(1)
    cy.get('.v-list-item-title').contains('Nastaviť ako verejné').click()
    cy.waitSec(1)
    cy.getCy('button-confirm').should('be.visible').click()
