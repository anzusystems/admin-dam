...
- **Dependency bumps:** vuetify `^3.11.8` → `^4.1.5`, vue-router `^5.0.2` → `^5.2.0`, pinia `^3.0.4` → `^4.0.2`, vue `3.5.28` → `3.5.40`, vue-i18n `^11.2.8` → `^11.4.7`, @anzusystems/common-admin `1.47.0-beta.354` → `1.47.0-beta.dev-1784059866`, @tiptap/vue-3 `^3.19.0` → `^3.28.0`, @sentry/vue `^10.38.0` → `^10.67.0`. Dev tooling also bumped (cypress, sass, vue-tsc, @vitejs/plugin-vue, @stylistic/eslint-plugin, @intlify/unplugin-vue-i18n, eslint-plugin-vue) + `dotenv` added.
